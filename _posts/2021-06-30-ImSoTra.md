...
This blog post contains an overview of my master thesis. For more detail explanation, please check my [final report](https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/document/2021_06_30_shreejas_final_thesis_2021.pdf). Digital files associated with the study including matlab scripts, original recording of sound pressure in the receiving room and the corresponding auralized sound pressure for the three sound sources can be found [here](https://github.com/shreejayshrestha/Master_Thesis_SMC_2021). A video demonstrating measurement process is also included at the end of the blog post.
...
<figure align="middle">
  ...
  <figure align="middle">
  <audio controls>
      <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/audio/2021_06_30_shreejas_mb_aur.wav" type="audio/wav">
  ...
  <figure align="middle">
  <audio controls>
      <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/audio/2021_06_30_shreejas_with_shoes_orig.wav" type="audio/wav">
   Your browser does not support the audio element.
  </audio>
  ...
  <figure align="middle">
  <audio controls>
      <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/audio/2021_06_30_shreejas_with_shoes_aur.wav" type="audio/wav">
   Your browser does not support the audio element.
  </audio>
  ...
  <figure align="middle">
  <audio controls>
      <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/audio/2021_06_30_shreejas_without_shoes_orig.wav" type="audio/wav">
   Your browser does not support the audio element.
  </audio>
  ...
  <figure align="middle">
  <audio controls>
      <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/audio/2021_06_30_shreejas_without_shoes_aur.wav" type="audio/wav">
   Your browser does not support the audio element.
  </audio>
...
<figure style="float: none">
  <video width="auto" controls>
    <source src="https://www.uio.no/english/studies/programmes/SMC-master/blog/assets/video/2021_06_30_shreejas_measuremet_process_comp2.mp4" type='video/mp4'>
